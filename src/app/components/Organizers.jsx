...
const Organizers = () => {
    return (
        <div id="organizers">
            <h1 className="afk-section-title afk-title text-2xl">The Organizers</h1>
