...
const Organizers = () => {
    return (
        <div id="organizers">
            ...
            <p className="mb-6 mt-1 flex justify-end text-sm pt-2 text-gray-700">Pictured counterclockwise from the left: Ida Wiber, Viljam Railio, Johnny Löfman, Linus Haga, Eric Häggblom, Adam Beijar, Tyra Vironmäki, Max Ruotsalainen och Madeleine Ringbom</p>
