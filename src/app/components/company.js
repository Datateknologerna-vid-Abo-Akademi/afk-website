...
export const Company = (props) => {
  ...
  return (
    <div className={"bg-primary rounded-lg p-2 h-56 m-1 flex items-center justify-center cursor-pointer transition duration-300 ease-in-out hover:bg-secondary"} id="company" onClick={() => props.handleClick(props.company)}>
