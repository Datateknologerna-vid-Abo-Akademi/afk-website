...
const Header = () => {
  return (
    <nav className="bg-primary flex items-center justify-between fixed border-black shadow-md top-0 h-fit w-full z-30 opacity-95" id="header">
      <div className="mx-5 flex items-center justify-center p-2">
        <Image src="/images/AFK_logo_small.png" alt="AFK logo" height={80} width={80} className="p-1"/>
      </div>
      <div className="mx-5 flex items-center gap-10 p-6 text-lg">
