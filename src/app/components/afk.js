    ...
    return (
        <div id="afk">
            <div className="px-10 pt-10">
                ...
                <p className="text-md">Albins Företagskonferens AFK2025 is a recruitment fair organized by <a className="font-bold text-blue-500 hover:text-primary" href="https://datateknologerna.org/">Datateknologerna vid Åbo Akademi rf</a>, aimed at students from Åbo Akademi University and the University of Turku. The event was organized for the first time in the spring of 2024 and we got very positive feedback from both companies and students. Now we are expanding the fair with even more participants. The fair will be held on Friday 5th of December 2025.</p>
                <br />
                <p className="text-md">
                The day begins with the recruitment fair, and after that, there will be a small cocktail party in the same building. The fair will be held at our student campus, to bring visibility to IT students of both universities.
                </p>
            </div>
            <div className="p-10">
