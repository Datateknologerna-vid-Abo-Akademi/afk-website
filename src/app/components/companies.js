    ...
    return (
        <div className="relative w-full flex flex-col transition-all duration-300 ease-in-out">
            ...
            <div className="grid grid-rows-[auto,1fr] max-h-[30rem] w-full transition-all duration-300 ease-in-out">
                ...
                <div className={`relative grid grid-cols-4 gap-2 overflow-y-scroll overflow-x-hidden w-full transition-all duration-300 ease-in-out ${selectedCompany ? "opacity-0 invisible scale-95" : "opacity-100 visible scale-100"}`}>
