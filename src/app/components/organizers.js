...
const Organizers = () => {
    return (
        <div id="organizers">
            ...
            <p className="md:inline-block hidden text-sm pt-2 text-gray-700">Pictured from right to left: Ida Wiberg, Johnny Löfman, Adam Beijar, Anton Näsman, Rasmus Vilen, Valter Lax, Hugo Söderholm</p>
        </div>
    )
};
