...
const Header = () => {
    ...
    return (
        <nav
            className={`flex items-center justify-between fixed left-0 w-full z-20 transition-transform duration-300 border-b border-blue-500/30 bg-black/70 backdrop-blur ${hidden ? "-translate-y-full" : "translate-y-0"}`}
            id="header"
        >
            <button
